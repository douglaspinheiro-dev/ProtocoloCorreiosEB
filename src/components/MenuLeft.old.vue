  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <q-item-section icon="lock outline" />
          <q-item-label label="Alterar Senha" />
        </q-item>
      ...
      <q-item
        ...
        @click.native="logout"
      >
        <q-item-section icon="exit to app" />
        <q-item-label
          label="Sair"
      ...
      <q-separator />
      <q-item-label>Menu de Navegação</q-item-label>
      ...
      >
        ...
        >
          <q-item-section icon="supervisor account" />
          <q-item-label
      ...
      >
        ...
        >
          <q-item-section icon="fas fa-file-contract" />
          <q-item-label label="Tipos de Documentos" />
        </q-item>
        ...
        >
          <q-item-section icon="fas fa-envelope" />
          <q-item-label label="Tipos de Correspondencias" />
        </q-item>
        ...
        >
          ...
          <q-item-label label="Tipos de Cobrancas" />
        </q-item>
        ...
        >
          <q-item-section icon="fas fa-map-marked-alt" />
          <q-item-label label="Endereços" />
        </q-item>
        ...
        >
          <q-item-section icon="work_outline" />
          <q-item-label label="Setores Internos" />
        </q-item>
        ...
        >
          <q-item-section icon="fas fa-file-alt" />
          <q-item-label label="Protocolo de Entrada" />
        </q-item>
        ...
        >
          <q-item-section icon="move_to_inbox" />
          <q-item-label label="Malotes" />
        </q-item>
        ...
        >
          <q-item-section icon="mail_outline" />
          <q-item-label label="Correspondencias" />
        </q-item>
