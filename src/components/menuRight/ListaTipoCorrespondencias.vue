...
export default {
  ...
  mounted () {
    ...
    this.$root.$on('adicionaRegistroNaLista', (obj) => {
      let tipoCorrespondencia = new TipoCorrespondencia()
      tipoCorrespondencia.tipoCorrespondencia = obj.tipoCorrespondencia
      tipoCorrespondencia.codigo = obj.codigo
      tipoCorrespondencia.descricao = obj.descricao
